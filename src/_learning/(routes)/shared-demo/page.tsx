    ...
    <main className="max-w-5xl mx-auto p-6">
      ...
      <Section title="Buttons — Figma Sizes">
        <div className="flex flex-col items-start gap-4">
          ...
          <Button size="figma-2xl" fullWidth>
            Add Accounts
          </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card hoverable padding="lg">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Interactive styles visible on hover.
            </p>
          </Card>
        </div>
      </Section>
      ...
      <Section title="Sidebar Profile">
        <div className="rounded-2xl bg-card p-6">
          <SidebarProfile
            name="Tanzir Rahman"
            onViewProfile={() => {}}
            menuItems={[{ label: "Settings" }, { label: "Sign out" }]}
          />
        </div>
      ...
      <Section title="Sidebar">
        <div className="h-160 w-fit overflow-hidden rounded-2xl">
          <Sidebar
            ...
            profileMenuItems={[{ label: "Settings" }, { label: "Sign out" }]}
          />
        </div>
      </Section>
        ...
        <div className="flex gap-3 items-center">
          ...
          >
            <p className="text-sm text-gray-600">
              This is an example modal using the shared `Modal` component.
            </p>
      ...
      <Section title="Loaders / Skeletons">
        <div className="flex gap-4 items-start">
          <div className="flex items-center gap-2">
            <Spinner /> <span className="text-sm text-gray-600">Spinner</span>
          </div>
          <div className="w-60">
      ...
      <div className="mt-12 text-sm text-gray-500">
        This page renders a curated set of components from the shared UI kit.
      </div>
      ...
      <Section title="Checkbox">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <Label htmlFor="cb-checked" className="text-body-md">
              Keep me signed in (checked)
            </Label>
          </div>
          <div className="flex items-center gap-3">
            <Checkbox id="cb-unchecked" />
            <Label htmlFor="cb-unchecked" className="text-body-md">
              Keep me signed in (unchecked)
            </Label>
          </div>
          <div className="flex items-center gap-3">
            <Checkbox id="cb-disabled" disabled />
            <Label htmlFor="cb-disabled" className="text-body-md text-gray-03">
              Disabled
            </Label>
          </div>
        </div>
        ...
        <div className="space-y-3 divide-y divide-border">
          {[
            ...
            },
            {
              cls: "text-display-sm",
              label: "display-sm",
              spec: "20px / 28px / Semibold",
            },
            {
              cls: "text-heading-lg",
              label: "heading-lg",
              spec: "18px / 24px / Semibold",
            },
            {
              cls: "text-heading-md",
              label: "heading-md",
              spec: "16px / 24px / Semibold",
            },
            {
              cls: "text-body-lg",
              label: "body-lg",
              spec: "16px / 24px / Regular",
            },
            {
              cls: "text-body-md",
              label: "body-md",
              spec: "14px / 20px / Regular",
            },
            {
              cls: "text-body-sm",
              label: "body-sm",
              spec: "12px / 16px / Regular",
            },
            {
              cls: "text-label-lg",
              label: "label-lg",
              spec: "14px / 20px / Medium",
            },
            {
              cls: "text-label-md",
              label: "label-md",
              spec: "12px / 16px / Medium",
            },
          ].map(({ cls, label, spec }) => (
            <div
              key={cls}
              className="flex items-baseline justify-between pt-3 first:pt-0"
            >
              <span className={cls}>The quick brown fox jumps</span>
              <span className="text-body-sm text-gray-02 ml-4 shrink-0">
                .{label} — {spec}
              </span>
            </div>
          ))}
